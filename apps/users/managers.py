...
class CustomUserManager(BaseUserManager):
    ...
    def create_user(
        ...
        if not first_name:
            raise ValueError(_("User must provide a first name"))
        ...
        if email:
            ...
            raise ValueError(_('BAse User Account: An e mail address is required.'))
        ...
        extra_fields.setdefault("is_supeuser", False)
